...
_bloodbagLastUsedTime = 1800; // Amount of time in seconds before player can use self bloodbag again after a succesful use
...
_infectedLifeLost = 500; // Amount of life to loose in becomes infected
