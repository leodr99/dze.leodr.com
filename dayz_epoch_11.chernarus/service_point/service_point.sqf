...
_repair_costs = [
	["Air",["ItemGoldBar",3]], // 3 Gold for helicopters and planes
...
_rearm_costs = [
	["ArmoredSUV_PMC_DZE",["ItemGoldBar10oz",1]], // special costs for a single vehicle type
	["Air",["ItemGoldBar10oz",2]], // 2 10oz Gold for helicopters and planes
	["AllVehicles",["ItemGoldBar",5]] // 1 5oz Gold for all other vehicles
];
