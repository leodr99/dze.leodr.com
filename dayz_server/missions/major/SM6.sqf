...
[nil,nil,rTitleText,"Bandits have taken over an Ikea Truck! Check your map for the location!", "PLAIN",10] call RE;
...
_hummer = createVehicle ["Ural_INS",[(_coords select 0) + 25, (_coords select 1) - 5,0],[], 0, "CAN_COLLIDE"];
...
sleep 5;
_aispawn = [_coords,30,4,3,1] execVM "\z\addons\dayz_server\missions\add_unit_server.sqf";//AI Guards
sleep 5;
_aispawn = [_coords,50,4,3,1] execVM "\z\addons\dayz_server\missions\add_unit_server.sqf";//AI Guards
sleep 5;
_aispawn = [_coords,40,4,3,1] execVM "\z\addons\dayz_server\missions\add_unit_server.sqf";//AI Guards
...
[nil,nil,rTitleText,"Survivors have taken control of the Ikea Truck.", "PLAIN",6] call RE;
